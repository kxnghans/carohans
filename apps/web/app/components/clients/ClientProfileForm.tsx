...
export const ClientProfileForm = ({ initialData, onSubmit, onCancel, submitLabel = "Update Profile", compact = false }: ClientProfileFormProps) => {
    ...
    return (
        <div className={compact ? "space-y-4" : "space-y-6"}>
            ...
            <div className="space-y-1.5">
                <label className="text-theme-caption font-black text-muted uppercase tracking-wider">Username</label>
                <div className="relative">
                    <User className={`${compact ? "w-3.5 h-3.5 top-3" : "w-4 h-4 top-4"} absolute left-3 text-muted`} />
                    <input 
            ...
            <div className="space-y-1.5">
                <label className="text-theme-caption font-black text-muted uppercase tracking-wider">Default Delivery Address</label>
                <div className="relative">
                    <MapPin className={`${compact ? "w-3.5 h-3.5 top-3" : "w-4 h-4 top-4"} absolute left-3 text-muted`} />
                                            ...
                                            />                </div>
                {!compact && <p className="text-theme-caption text-muted font-bold uppercase tracking-tight ml-1">Optional - used for automatic delivery calculations</p>}
            </div>
