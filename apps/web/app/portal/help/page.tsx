...
import { getClientHelpSections } from '../../lib/clientHelpData';
import { Card } from '../../components/ui/Card';
import { useAppStore } from '../../context/AppContext';

export default function PortalHelpPage() {
    const { latePenaltyPerDay } = useAppStore();
    const sections = getClientHelpSections(latePenaltyPerDay);
    ...
    return (
        <div className="animate-in fade-in duration-500 space-y-8 w-full max-w-[90rem] mx-auto pb-12">
            <div className="mb-2 px-1">
                ...
                <p className="text-theme-body text-muted">Everything you need to know about renting with CaroHans.</p>
            </div>
